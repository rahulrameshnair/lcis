...
class LCI:
    ...
    def LCI_database_list(self, keys_biosphere, keys_technosphere, keys_production):
        LCI_database_list = [] # A list of dictionaries to store the entire life cycle inventory
        ...
        ####### Store this parameter dictionary into the lci_database_list
        LCI_database_list = [parameters]

        ####### To start storing information realted to each activities
        activities_dict = {}
