...
This file applies presentation formatting to Excel workbooks generated from
LCIS/Brightway inventory exports. It depends on openpyxl for workbook loading,
cell styles, alignments, fills, and column sizing.
"""
import openpyxl
...
def excel_format(excel_file, output_excel_file):
    ...
    """
    """
    The formatter scans the exported workbook for known section headings and
    field labels, then applies colors, emphasis, alignment, and fixed column
    widths. It does not alter inventory values; it only improves readability
    of the generated Excel file for review.
    """
